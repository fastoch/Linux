...
It's very important to use some Linux file system on your usb drive, because if you use FAT file system, rsync won't be able to copy all the files attributes.
